...
const Layout: React.FC = () => {
  ...
  const is3DMode = location.pathname === '/3d';

  return (
    <div className={`min-h-screen bg-brand-black text-white selection:bg-white selection:text-black flex flex-col ${is3DMode ? 'overflow-hidden' : ''}`}>
