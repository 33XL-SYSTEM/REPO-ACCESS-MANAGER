      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-black/40 backdrop-blur-md relative z-10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1.5 md:gap-2">
            <span className="text-[10px] text-white/40 uppercase tracking-widest hidden sm:inline">LIVE PREVIEW //</span>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 border border-white/10 text-white/60 hover:text-white hover:bg-white/5 transition-all text-[10px] uppercase tracking-wider"
          >
            <RotateCcw size={12} />
        ...
        {isLoading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-brand-black/95 z-0">
            <div className="text-center space-y-2 max-w-md px-6">
              ...
              <p className="text-[11px] text-white/80 uppercase tracking-widest font-bold">Iniciando Preview Remoto</p>
              <div className="text-[9px] text-white/40 space-y-1 text-left font-mono border border-white/5 p-3 bg-white/[0.01]">
