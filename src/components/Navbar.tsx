  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-6 py-4 flex justify-between items-center glass-dark border-b border-white/10">
      <div className="flex items-center gap-4">
        ...
        <a href="https://github.com/Cauan33XL" target="_blank" rel="noopener noreferrer" className="hidden lg:flex items-center gap-2 text-sm font-mono text-white/80 hover:text-white transition-colors font-bold tracking-widest">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 flex gap-4 md:gap-8 items-center font-mono text-[10px] md:text-sm uppercase tracking-widest text-white/60">
        ...
        <Link to="/about" className="hover:text-white transition-colors flex items-center gap-1.5">
          <TerminalSquare size={14} className="hidden sm:block" /> Sobre
        </Link>
        <Link to="/contact" className="hover:text-white transition-colors flex items-center gap-1.5">
          <Mail size={14} className="hidden sm:block" /> Contato
        </Link>
      </div>
